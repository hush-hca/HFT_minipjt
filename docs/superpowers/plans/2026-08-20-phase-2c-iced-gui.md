...
- Still required for the full Phase 2C gate: detailed presenter modules for execution views, remaining GUI/data-plane failure-state tests, and the three-OS CI workflow.
